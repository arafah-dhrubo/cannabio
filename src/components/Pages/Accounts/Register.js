...
const Register = () => {
  ...
  console.log(user)
  return (
    <div><div className='md:w-3/6 w-5/6 mx-auto border-2 px-3 py-4 my-28 bg-gray-900'>
    ...
    <p className='text-white text-center'>Already User? <Link to="/login" className='text-green-500'>Login!</Link></p>
  </div></div>
  )
}
